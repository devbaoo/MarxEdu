...
export const GET_MARXIST_PHILOSOPHY_MULTI_AI_STATS_ENDPOINT = `${BASE_URL}/marxist-philosophy/multi-ai-stats`;
export const GET_MARXIST_PHILOSOPHY_RATE_LIMITER_STATS_ENDPOINT = `${BASE_URL}/marxist-philosophy/rate-limiter-stats`;
